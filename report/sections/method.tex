\chapter{Method}
% Dani: Kapitel 4 kääns som ett referat som går igenom din implementation/kod. Tänk på att den som läser
%ska kunna förstå varför vissa lösningar var nödvändiga, får en bra överblick av ditt system. Kanske bra att
%börja med en flow diagram eller liknande.
%
...
The different steps of detection and their purpose are summarised below: % TODO THIS!!!!!
\begin{itemize}
	\item Preprocessing. 
	\item Edge detection.
	\item Line detection.
...
\subsection{Measuring} % TODO describe 2 face vs 3 face recognition
