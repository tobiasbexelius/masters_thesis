...
% Dani: Kapitel 3 - du beskriver ett antal områden men det är igen inte klar hur exakt det relaterar till ditt arbete.
%
% För att kunna räkna ut 
%
% Beskriv hur områdena hänger ihop.Hur rubrikerna leder till varandra
%
