\chapter{Theoretical Background} % TODO möjligen "Projective geometry"
% TODO Bra vore om du redan i början av kapitlet har en förklaring till vad du behöver, så att man förstår poängen med det som presenteras.
...
This section describes how to determine the camera matrix $P$, and its components. % TODO reformulate
...
There are many techniques to solve this problem which is known as Perspective-n-Point (PnP). % TODO improve this section
...
% Frågan är om de i nästa kapitel förklara i grova drag hur de bildbehamndlingsmetoder som används fungerar.
