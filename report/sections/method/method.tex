...
\section{Implementation} % is this a good organisation?
This section presents the methods use when implementing the algorithms used to solve the problem. % Todo rephrase

\subsection{Software}
The most important piece of software used in this thesis is the library OpenCV, an open source library for computer vision. % footnote to opencv homepage?
...
% TODO Add figure! or maybe in results?
...
% skriva att olika bilder används för konstant-optimering och testning?
