...
\input{floats/detection_by_package}
...
\input{floats/detection_by_position}
...
\input{floats/detection_by_distance}
...
\input{floats/detection_by_height}
...
\input{floats/key_measure_overall}

% TODO text?

\input{floats/key_measure_by_package}
...
\input{floats/key_measure_by_position}
...
\input{floats/key_measure_by_distance}
\input{floats/key_measure_by_height}
...
\input{floats/measure_overall}

\input{floats/measure_by_package}
...
\input{floats/measure_by_position}

Bla bla distance table... % TODO

\input{floats/measure_by_distance}

Bla bla height table... % TODO

\input{floats/measure_by_height}
