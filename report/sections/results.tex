...
% Dani: Resultat kapitelet kan också utvecklas - speciellt online testing - detta är alldeles för kort beskrivet.
%
% Mer beskrivande text. 
%
% Error i bilden vs världen
%
% Detection and localisation
%
% Motivera varför jag valde 1, 1.5, 2 meter etc. (i metod)
%
% relative error -> average relative error
%
% duplicering av mening nånstans
%
% procent istället
%
% Find out why error increases so little with distance.
%
% Motivera error metric
