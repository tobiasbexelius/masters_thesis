...
\section{Measuring}
The tables in section \ref{results:measuring} showed that vanishing point calibration failed more often than when using Zhang's method, but the accuracy was the same between the two methods. % TODO split error into x,y,z
