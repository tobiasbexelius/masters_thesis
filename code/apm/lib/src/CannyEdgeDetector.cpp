...
CannyEdgeDetector::CannyEdgeDetector(int low_threshold, int high_threshold, int kernel_size) :
		low_threshold(low_threshold), high_threshold(high_threshold), kernel_size(kernel_size) {
}
